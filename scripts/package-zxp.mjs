...
if (!new RegExp(`^v${escapedVersion}(?:-[0-9A-Za-z][0-9A-Za-z.-]*)?$`).test(releaseTag)) throw new Error(`RELEASE_TAG (${releaseTag}) must match v${packageJson.version} or use a prerelease suffix.`);
